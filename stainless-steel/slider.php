  ...
  <div class="main-top-banner border-b-2 border-black relative">
    <div id="wowslider-container1">
      <div class="ws_images">
        <ul>
          <li>
            <img src="<?php echo $URL ?>assests/imgs/stainless-steel/Slider/gen_62.jpg" />
          </li>
          <li>
            <img src="<?php echo $URL ?>assests/imgs/stainless-steel/Slider/gen_64.jpg" />
          </li>
          <li>
            <img src="<?php echo $URL ?>assests/imgs/stainless-steel/Slider/gen_65.jpg" />
          </li>
          <li>
            <img src="<?php echo $URL ?>assests/imgs/stainless-steel/Slider/gen_66.jpg" />
          </li>
        </ul>
      </div>
    </div>
